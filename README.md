...
│   ├── doctors/        # صور الأطباء الاستشاريين (dr-mohamed-dohak, dr-khaled, dr-samar, dr-kashmar)
│   ├── clinic/         # صور جولة وأجنحة العيادة (clinic-01.jpg .. clinic-08.jpg)
│   ├── treatments/     # صور الأقسام والعلاجات (filler-botox.jpg)
│   └── works/          # أغلفة فيديوهات بعض أعمالنا (work-01.jpg .. work-06.jpg)
│
├── videos/             # فيديوهات قسم "بعض أعمالنا" (work-01.mp4 .. work-06.mp4)
│
└── public/             # نسخة المجلد الثابت المتوافقة مع أطر العمل ومتعقبة بملفات .gitkeep
    ├── images/
    └── videos/
```
...
1. أضف صورك الجديدة داخل المجلد:
   `images/clinic/` (أو `public/images/clinic/`)
...
2. افتح ملف `index.html` وتوجه للمصفوفة `CLINIC_PHOTOS` (حوالي السطر 2850):
   ```javascript
   const CLINIC_PHOTOS = [
     { id: 1, src: "./images/clinic/clinic-01.jpg", alt: "COSMODERM Reception Lounge", featured: true },
     { id: 2, src: "./images/clinic/clinic-02.jpg", alt: "COSMODERM Consultation Suite", featured: false },
...
1. ضع الصورة الشخصية للطبيب الجديد داخل:
   `images/doctors/dr-name.jpg` (أو `public/images/doctors/dr-name.jpg`)
2. افتح ملف `index.html` وتوجه للمصفوفة `DOCTORS` (حوالي السطر 2360):
   ```javascript
   {
     ...
     image: "./images/doctors/dr-name.jpg"
   }
   ```
...
3. افتح ملف `index.html` وأضف العنصر داخل مصفوفة `WORK_VIDEOS`:
   ```javascript
   {
     ...
     video: "./videos/work-07.mp4",
     poster: "./images/works/work-07.jpg",
